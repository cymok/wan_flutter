...
import 'package:wan_flutter/main_page.dart';
import 'package:wan_flutter/providers/account_provider.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        home: const MainPage(title: 'Wan Android'),
      ),
    );
  }
}
